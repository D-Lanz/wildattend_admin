...
3. Install dependencies using `npm install`, `npm install @mui/material @emotion/react @emotion/styled @mui/icons-material @mui/x-data-grid`, `npm install papaparse` , `npm install firebase-admin`.
